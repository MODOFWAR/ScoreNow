...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Khula:wght@700;800&display=swap" rel="stylesheet">
  ...
  <body>
    <div class="container1">
            ...
            <div class="container-fluid">
              <a class="navbar-brand scorenow" href="#">ScoreNow</a>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav1">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item navbar2">
                <a class="nav-link" href="/welcome">News</a>
              </li>
              <li class="nav-item navbar2">
